...
namespace Microsoft.Data.SqlClient.Server
{
    ...
    internal static partial class ValueUtilsSmi
    {
        ...
        internal static DateTimeOffset GetDateTimeOffset(ITypedGettersV3 getters, int ordinal, SmiMetaData metaData, bool gettersSupport2008DateTime)
        {
            if (gettersSupport2008DateTime)
            {
                return GetDateTimeOffset((SmiTypedGetterSetter)getters, ordinal, metaData);
            }
            ThrowIfITypedGettersIsNull(getters, ordinal);
            object result = GetValue(getters, ordinal, metaData);
            if (result == null)
        ...
        internal static SqlBytes GetSqlBytes(ITypedGettersV3 getters, int ordinal, SmiMetaData metaData)
        {
            SqlBytes result;
        ...
        internal static SqlChars GetSqlChars(ITypedGettersV3 getters, int ordinal, SmiMetaData metaData)
        {
            SqlChars result;
        ...
        internal static SqlXml GetSqlXml(ITypedGettersV3 getters, int ordinal, SmiMetaData metaData)
        {
            SqlXml result;
        ...
        internal static void FillCompatibleITypedSettersFromReader(ITypedSettersV3 setters, SmiMetaData[] metaData, SqlDataReader reader)
        {
                ...
                else
                {
                    switch (metaData[i].SqlDbType)
                    {
                        case SqlDbType.BigInt:
                            ...
                            ValueUtilsSmi.SetInt64_Unchecked(setters, i, reader.GetInt64(i));
                            break;
                        case SqlDbType.Binary:
                            Debug.Assert(CanAccessSetterDirectly(metaData[i], ExtendedClrTypeCode.SqlBytes));
                            ValueUtilsSmi.SetSqlBytes_LengthChecked(setters, i, metaData[i], reader.GetSqlBytes(i), 0);
                            break;
                        case SqlDbType.Bit:
                        ...
                        case SqlDbType.Char:
                            ...
                            SetSqlChars_LengthChecked(setters, i, metaData[i], reader.GetSqlChars(i), 0);
                            break;
                        case SqlDbType.DateTime:
                        ...
                        case SqlDbType.Decimal:
                            ...
                            SetSqlDecimal_Unchecked(setters, i, reader.GetSqlDecimal(i));
                            break;
                        case SqlDbType.Float:
                        ...
                        case SqlDbType.Image:
                            Debug.Assert(CanAccessSetterDirectly(metaData[i], ExtendedClrTypeCode.SqlBytes));
                            SetSqlBytes_LengthChecked(setters, i, metaData[i], reader.GetSqlBytes(i), 0);
                            break;
                        case SqlDbType.Int:
                        ...
                        case SqlDbType.Money:
                            ...
                            SetSqlMoney_Unchecked(setters, i, metaData[i], reader.GetSqlMoney(i));
                            break;
                        case SqlDbType.NChar:
                        case SqlDbType.NText:
                        case SqlDbType.NVarChar:
                        ...
                        case SqlDbType.SmallMoney:
                            Debug.Assert(CanAccessSetterDirectly(metaData[i], ExtendedClrTypeCode.SqlMoney));
                            SetSqlMoney_Checked(setters, i, metaData[i], reader.GetSqlMoney(i));
                            break;
                        case SqlDbType.Text:
                            Debug.Assert(CanAccessSetterDirectly(metaData[i], ExtendedClrTypeCode.SqlChars));
                            SetSqlChars_LengthChecked(setters, i, metaData[i], reader.GetSqlChars(i), 0);
                        ...
                        case SqlDbType.Xml:
                            ...
                            SetSqlXml_Unchecked(setters, i, reader.GetSqlXml(i));
                            break;
                        case SqlDbType.Variant:
...
/*XmlRd*/{ _ ,  _ ,  _ , _ , _ , _  , _ , _ , _  , _  , _  , _  , _  , _ , _ , _  , _ , _  , _  , _ , _ , _  , _  , _  , _ , _  , _ , _ , _ ,  _ , _,  _  , _  , _  , _ , },/*XmlReader*/
    //     BI, Bin, Bit, Ch, DT, Dec, Fl, Im, Int, Mny, NCh, NTx, NVC, Rl, UI, SDT, SI, SMn, Txt, TS, TI, VBn, VCh, Var, 24, Xml, 26, 27, 28, Udt, St, Dat, Tm, DT2, DTO
        ...
        private static SqlXml GetSqlXml_Unchecked(ITypedGettersV3 getters, int ordinal)
        {
            ...
            Stream copy = ValueUtilsSmi.CopyIntoNewSmiScratchStream(s);
